 ...
 * 
 */
@WebServiceClient(name = "WeatherInterfaceService", targetNamespace = "http://cxf.tf.cn/", wsdlLocation = "http://127.0.0.1:11111/weather?wsdl")
    ...
    extends Service
{
    ...
    private final static QName WEATHERINTERFACESERVICE_QNAME = new QName("http://cxf.tf.cn/", "WeatherInterfaceService");
    ...
    public WeatherInterface getWeatherInterfacePort() {
        return super.getPort(new QName("http://cxf.tf.cn/", "WeatherInterfacePort"), WeatherInterface.class);
    }
    ...
    public WeatherInterface getWeatherInterfacePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://cxf.tf.cn/", "WeatherInterfacePort"), WeatherInterface.class, features);
    }
