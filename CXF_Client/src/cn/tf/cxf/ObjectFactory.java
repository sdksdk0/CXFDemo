 ...
 * generated in the cn.tf.cxf package. 
...
public class ObjectFactory {
    ...
    private final static QName _QueryWeatherResponse_QNAME = new QName("http://cxf.tf.cn/", "queryWeatherResponse");
    private final static QName _QueryWeather_QNAME = new QName("http://cxf.tf.cn/", "queryWeather");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: cn.tf.cxf
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://cxf.tf.cn/", name = "queryWeatherResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://cxf.tf.cn/", name = "queryWeather")
